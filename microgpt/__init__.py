...
Pre-trained Transformer) with state-of-the-art features including:

- Core: Pure Python transformer with autograd
- Training: Adam, advanced optimizers, LR scheduling
- Architecture: Multi-layer, multi-head, modern techniques
  (RoPE, SwiGLU, etc.)
- Efficiency: Quantization, LoRA, gradient
  checkpointing
- Inference: PagedAttention, speculative decoding,
  continuous batching
...
Example:
    ...
    >>> model = GPT(vocab_size=256, block_size=16, n_layer=2,
    ...             n_embd=32)
...
from .data import CharTokenizer, DataLoader, BPETokenizer, preprocess_text
...
# Modern architecture
from .modern_architecture import ModernGPT, RoPE, SwiGLU, ALiBi
...
# Multimodal
from .multimodal import VisionEncoder, AudioEncoder, MultiModalGPT, ToolUse, RAG
...
# Memory efficiency
from .memory_efficient import LoRA, QLoRA, DoRA, ReLoRA, GaLore
...
# Model merging
from .model_merging import TIESMerging, DARE, ModelSoups, TaskArithmetic, SLERP

# Evaluation
from .evaluation import PerplexityMetrics, BLEU, ROUGE, ComprehensiveEvaluator

# Reasoning
from .reasoning import ChainOfThought, TreeOfThought, ReAct, Reflexion, SelfConsistency
...
from .compression import MagnitudePruning, KnowledgeDistillation

# Model zoo
from .model_zoo import create_model, ModelZoo

# Tokenizers
from .tokenizers import create_tokenizer

list_models = ModelZoo.list_models
