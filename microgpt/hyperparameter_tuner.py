...
class HyperparameterTuner:
    ...
    def grid_search(
        self, train_func: Callable, eval_func: Callable, param_grid: Dict[str, List[Any]]
    ) -> Dict[str, Any]:
        ...
        for combination in itertools.product(*values):
            ...
            self.results.append({"params": params, "score": score, "config": config})
    ...
    def random_search(
        self, train_func: Callable, eval_func: Callable, n_iter: int = 10
    ) -> Dict[str, Any]:
    ...
    def _train_and_eval(self, config: Any, train_func: Callable, eval_func: Callable) -> float:
    ...
    def save_results(self, path: str = "tuning_results.json"):
        ...
        data = {
            ...
            "all_results": [{"params": r["params"], "score": r["score"]} for r in self.results],
        }
