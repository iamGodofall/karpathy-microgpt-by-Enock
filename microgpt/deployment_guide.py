...
"""
    ...
    def _create_dockerfile(self, deploy_dir: Path):
        """Create Dockerfile."""
        dockerfile = """FROM python:{self.config.python_version}-slim
...
"""
    ...
    def _gcp_cloud_functions_config(self) -> Dict:
        ...
        return {
            ...
            "memory": "2GB",
            "timeout": "60s",
            "environmentVariables": {"MICROGPT_CONFIG": "config.yaml"},
        }
...
if __name__ == "__main__":
    ...
    config = DeploymentConfig(
        name="microgpt-prod", container=True, enable_api=True, enable_web=True
    )
