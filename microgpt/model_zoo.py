...
class ModelZoo:
    ...
    def tiny() -> Config:
        ...
        return Config(
            ...
            training=TrainingConfig(num_steps=1000, learning_rate=0.01, lr_schedule="linear"),
            generation=GenerationConfig(temperature=0.8, max_length=20),
        )
    ...
    def small() -> Config:
        ...
        return Config(
            ...
            generation=GenerationConfig(temperature=0.7, top_k=40, max_length=50),
        )
    ...
    def medium() -> Config:
        ...
        return Config(
            ...
            generation=GenerationConfig(temperature=0.6, top_k=40, top_p=0.95, max_length=100),
        )
    ...
    def large() -> Config:
        ...
        return Config(
            ...
            generation=GenerationConfig(temperature=0.5, top_k=50, top_p=0.95, max_length=200),
        )
    ...
    def names_generator() -> Config:
        ...
        return Config(
            ...
            training=TrainingConfig(
                num_steps=10000, learning_rate=0.01, lr_schedule="cosine", warmup_steps=500
            ),
            generation=GenerationConfig(temperature=0.8, top_k=10, max_length=15),
        )
    ...
    def code_generator() -> Config:
        ...
        return Config(
            ...
            generation=GenerationConfig(temperature=0.4, top_k=40, top_p=0.95, max_length=512),
        )
    ...
    def chat_model() -> Config:
        ...
        return Config(
            ...
            generation=GenerationConfig(temperature=0.7, top_k=50, top_p=0.9, max_length=256),
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--create", type=str, help="Create model config (tiny/small/medium/large/names/code/chat)"
    )
