...
from interpretability import AttentionVisualizer, NeuronAnalyzer, ProbingClassifier, analyze_model
...
def main():
    ...
    model = GPT(
        vocab_size=loader.tokenizer.vocab_size, block_size=32, n_layer=2, n_embd=32, n_head=4
    )
