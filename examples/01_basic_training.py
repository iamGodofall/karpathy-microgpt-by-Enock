...
def main():
    ...
    config = TrainingConfig(
        num_steps=500, learning_rate=0.01, lr_schedule="linear", eval_interval=100
    )
    ...
    for step in range(config.num_steps):
        ...
        tokens = (
            ...
            + [loader.tokenizer.char_to_idx.get(ch, loader.tokenizer.bos_token) for ch in doc]
            + [loader.tokenizer.bos_token]
        )
    ...
    for i in range(5):
        tokens = model.generate(loader.tokenizer.bos_token, max_length=15, temperature=0.8)
