...
from trainer import AdamOptimizer, TrainingConfig, Trainer, LRScheduler, EarlyStopping
...
class TestEarlyStopping(unittest.TestCase):
    ...
    def test_early_stop_trigger(self):
        ...
        # Plateau
        self.assertFalse(stopper(0.79))  # Within min_delta
        self.assertFalse(stopper(0.79))
        self.assertFalse(stopper(0.79))
        self.assertTrue(stopper(0.79))  # Should trigger stop
    ...
    def test_improvement_reset(self):
        ...
        stopper(1.0)
        stopper(1.0)  # Count = 1
        stopper(0.5)  # Improvement, reset count
        stopper(0.5)  # Count = 1
        stopper(0.5)  # Count = 2
