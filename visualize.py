...
def generate_training_plot(log_file: str, output_file: str = "training_curves.html"):
    ...
    try:
        ...
        # Loss curve
        fig.add_trace(
            go.Scatter(x=steps, y=losses, mode='lines', name='Loss',
        ...
        # Perplexity curve
        fig.add_trace(
            go.Scatter(x=steps, y=perplexities, mode='lines', name='Perplexity',
        ...
        # Learning rate curve
        fig.add_trace(
            go.Scatter(x=steps, y=learning_rates, mode='lines', name='Learning Rate',
                      line=dict(color='red')),
            row=3, col=1
        )
